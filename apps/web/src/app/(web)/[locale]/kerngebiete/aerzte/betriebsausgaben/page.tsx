...
import {OperatingExpensesAdvantage} from "@/assets/data/messages/doctors";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("DoctorsOperatingExpensesPage");

  return generatePageMetadata(`/${currentLocale}/aerzte/betriebsausgaben`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('DoctorsOperatingExpensesPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {OperatingExpensesAdvantage.map(item => (
              <Box
                Icon={Check}
