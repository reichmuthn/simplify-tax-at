...
import {InvestingInYourOwnMedicalPracticeAdvantage} from "@/assets/data/messages/doctors";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("DoctorsInvestingInYourOwnMedicalPracticePage");

  return generatePageMetadata(`/${currentLocale}/aerzte/investitionen-in-die-eigene-aerztepraxis`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('DoctorsInvestingInYourOwnMedicalPracticePage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {InvestingInYourOwnMedicalPracticeAdvantage.map(item => (
              <Box
                Icon={Check}
