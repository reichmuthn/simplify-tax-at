...
import {DoctorsEmployeesAdvantage} from "@/assets/data/messages/doctors";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("DoctorsEmployeesPage");

  return generatePageMetadata(`/${currentLocale}/aerzte/mitarbeiter`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('DoctorsEmployeesPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {DoctorsEmployeesAdvantage.map(item => (
              <Box
                Icon={Check}
