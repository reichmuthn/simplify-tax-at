...
import {EstablishingAndManagingAPracticeAdvantage} from "@/assets/data/messages/doctors";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("DoctorsEstablishingAndManagingAPracticePage");
...
export default function Page() {
  ...
  const t = useTranslations('DoctorsEstablishingAndManagingAPracticePage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {EstablishingAndManagingAPracticeAdvantage.map(item => (
              <Box
                Icon={Check}
