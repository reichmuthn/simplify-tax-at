...
import {SalesOfPracticesAndSuccessionPlanningAdvantage} from "@/assets/data/messages/doctors";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("DoctorsSalesOfPracticesAndSuccessionPlanningPage");

  return generatePageMetadata(`/${currentLocale}/aerzte/praxisgruendung-und-fuehrung`, t("HeroArticle.title"), t("HeroArticle.description"));
}


export default function Page() {

  const t = useTranslations('DoctorsSalesOfPracticesAndSuccessionPlanningPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {SalesOfPracticesAndSuccessionPlanningAdvantage.map(item => (
              <Box
                Icon={Check}
