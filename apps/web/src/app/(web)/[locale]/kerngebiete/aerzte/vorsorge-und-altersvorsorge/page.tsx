...
import {ProvisionAndRetirementProvisionAdvantage} from "@/assets/data/messages/doctors";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("DoctorsProvisionAndRetirementProvisionPage");

  return generatePageMetadata(`/${currentLocale}/aerzte/vorsorge-und-altersvorsorge`, t("HeroArticle.title"), t("HeroArticle.description"));
}
...
export default function Page() {
  ...
  const t = useTranslations('DoctorsProvisionAndRetirementProvisionPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {ProvisionAndRetirementProvisionAdvantage.map(item => (
              <Box
                Icon={Check}
