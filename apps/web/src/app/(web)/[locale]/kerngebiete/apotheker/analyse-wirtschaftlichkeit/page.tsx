...
import {PharmacyEconomicAnalysisAdvantage} from "@/assets/data/messages/pharmasists";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("PharmacyEconomicAnalysisPage");

  return generatePageMetadata(`/${currentLocale}/analyse-wirtschaftlichkeit`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('PharmacyEconomicAnalysisPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {PharmacyEconomicAnalysisAdvantage.map(item => (
              <Box
                Icon={Check}
