...
import {PharmacyFoundingAndManagementAdvantage} from "@/assets/data/messages/pharmasists";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("PharmacyFoundingAndManagementPage");

  return generatePageMetadata(`/${currentLocale}/gruendung-und-fuehrung`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('PharmacyFoundingAndManagementPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {PharmacyFoundingAndManagementAdvantage.map(item => (
              <Box
                Icon={Check}
