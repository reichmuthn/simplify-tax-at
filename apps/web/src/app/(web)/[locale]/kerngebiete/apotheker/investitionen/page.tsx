...
import {PharmacyInvestmentsAdvantage} from "@/assets/data/messages/pharmasists";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("PharmacyInvestmentsPage");

  return generatePageMetadata(`/${currentLocale}/investitionen`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('PharmacyInvestmentsPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {PharmacyInvestmentsAdvantage.map(item => (
              <Box
                Icon={Check}
