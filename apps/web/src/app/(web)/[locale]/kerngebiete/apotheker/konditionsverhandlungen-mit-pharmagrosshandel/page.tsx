...
import {PharmacyConditionNegotiationsWithPharmaceuticalWholesalersAdvantage} from "@/assets/data/messages/pharmasists";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("PharmacyConditionNegotiationsWithPharmaceuticalWholesalersPage");

  return generatePageMetadata(`/${currentLocale}/konditionsverhandlungen-mit-pharmagrosshandel`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('PharmacyConditionNegotiationsWithPharmaceuticalWholesalersPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {PharmacyConditionNegotiationsWithPharmaceuticalWholesalersAdvantage.map(item => (
              <Box
                Icon={Check}
