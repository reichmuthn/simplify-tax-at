...
import {PharmacyEmployeesAdvantage} from "@/assets/data/messages/pharmasists";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("PharmacyEmployeesPage");

  return generatePageMetadata(`/${currentLocale}/mitarbeiter`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('PharmacyEmployeesPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {PharmacyEmployeesAdvantage.map(item => (
              <Box
                Icon={Check}
