...
import {pharmacistsAdvantage} from "@/assets/data/messages/pharmasists";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  return generatePageMetadata(`/${currentLocale}/start-ups`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('PharmacistPage');
