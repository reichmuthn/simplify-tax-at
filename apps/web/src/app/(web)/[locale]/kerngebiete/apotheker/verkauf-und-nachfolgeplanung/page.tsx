...
import {PharmacySaleAndSuccessionPlanningAdvantage} from "@/assets/data/messages/pharmasists";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("PharmacySaleAndSuccessionPlanningPage");

  return generatePageMetadata(`/${currentLocale}/verkauf-und-nachfolgeplanung`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('PharmacySaleAndSuccessionPlanningPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {PharmacySaleAndSuccessionPlanningAdvantage.map(item => (
              <Box
                Icon={Check}
