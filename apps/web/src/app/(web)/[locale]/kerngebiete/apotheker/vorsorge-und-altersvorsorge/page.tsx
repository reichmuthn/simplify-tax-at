...
import {PharmacyPensionAndRetirementProvisionAdvantage} from "@/assets/data/messages/pharmasists";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("PharmacyPensionAndRetirementProvisionPage");

  return generatePageMetadata(`/${currentLocale}/vorsorge-und-altersvorsorge`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('PharmacyPensionAndRetirementProvisionPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {PharmacyPensionAndRetirementProvisionAdvantage.map(item => (
              <Box
                Icon={Check}
