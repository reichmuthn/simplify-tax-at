...
import {automatedInvoicingToCustomersAdvantage} from "@/assets/data/messages/eCommerce";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("ECommerceAutomatedInvoicingToCustomersPage");

  return generatePageMetadata(`/${currentLocale}/automatisierte-fakturierung-an-kunden`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('ECommerceAutomatedInvoicingToCustomersPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {automatedInvoicingToCustomersAdvantage.map(item => (
              <Box
                Icon={Check}
