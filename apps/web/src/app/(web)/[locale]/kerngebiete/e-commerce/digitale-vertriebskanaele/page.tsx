...
import {digitalSalesChannelsAdvantage} from "@/assets/data/messages/eCommerce";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("ECommerceDigitalSalesChannelsPage");

  return generatePageMetadata(`/${currentLocale}/digitale-vertriebskanaele`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('ECommerceDigitalSalesChannelsPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {digitalSalesChannelsAdvantage.map(item => (
              <Box
                Icon={Check}
