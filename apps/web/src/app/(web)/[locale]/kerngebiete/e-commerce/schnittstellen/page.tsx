...
import {interfacesAdvantage} from "@/assets/data/messages/eCommerce";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("ECommerceInterfacesPage");

  return generatePageMetadata(`/${currentLocale}/schnittstellen`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('ECommerceInterfacesPage');
