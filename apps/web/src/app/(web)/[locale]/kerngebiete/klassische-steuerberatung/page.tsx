...
import {classicTaxAdviceBlock} from "@/assets/data/messages/classicTaxAdvice";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("ClassicTaxAdvicePage");

  return generatePageMetadata(`/${currentLocale}/klassische-steuerberatung`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('ClassicTaxAdvicePage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {classicTaxAdviceBlock.map(item => (
              <Box
                Icon={Check}
