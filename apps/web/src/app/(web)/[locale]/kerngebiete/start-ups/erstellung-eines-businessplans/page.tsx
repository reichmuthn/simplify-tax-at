...
import {BusinessplanAdvantage} from "@/assets/data/messages/startUps";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("StartUpsBusinessplanPage");

  return generatePageMetadata(`/${currentLocale}/erstellung-eines-businessplans`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('StartUpsBusinessplanPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {BusinessplanAdvantage.map(item => (
              <Box
                Icon={Check}
