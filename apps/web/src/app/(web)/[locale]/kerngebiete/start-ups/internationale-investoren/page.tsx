...
import {internationalInvestorsAdvantage} from "@/assets/data/messages/startUps";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("StartUpsInternationalInvestorsPage");

  return generatePageMetadata(`/${currentLocale}/immobiliinternationale-investorenen`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('StartUpsInternationalInvestorsPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {internationalInvestorsAdvantage.map(item => (
              <Box
                Icon={Check}
