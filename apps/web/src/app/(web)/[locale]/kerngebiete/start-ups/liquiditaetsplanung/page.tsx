...
import {LiquidityPlanningAdvantage} from "@/assets/data/messages/startUps";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("StartUpsLiquidityPlanningPage");

  return generatePageMetadata(`/${currentLocale}/liquiditaetsplanung`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('StartUpsLiquidityPlanningPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {LiquidityPlanningAdvantage.map(item => (
              <Box
                Icon={Check}
