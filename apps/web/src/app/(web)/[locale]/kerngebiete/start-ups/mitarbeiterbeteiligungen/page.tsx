...
import {EmployeeParticipationAdvantage} from "@/assets/data/messages/startUps";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("StartUpsEmployeeParticipationPage");

  return generatePageMetadata(`/${currentLocale}/mitarbeiterbeteiligungen`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('StartUpsEmployeeParticipationPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {EmployeeParticipationAdvantage.map(item => (
              <Box
                Icon={Check}
