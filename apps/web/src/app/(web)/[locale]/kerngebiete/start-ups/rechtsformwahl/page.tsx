...
import {choiceOfLegalFormAdvantage} from "@/assets/data/messages/startUps";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("StartUpsChoiceOfLegalFormPage");

  return generatePageMetadata(`/${currentLocale}/rechtsformwahl`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('StartUpsChoiceOfLegalFormPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {choiceOfLegalFormAdvantage.map(item => (
              <Box
                Icon={Check}
