...
import {GrowthStrategyAdvantage} from "@/assets/data/messages/startUps";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("StartUpsGrowthStrategyPage");

  return generatePageMetadata(`/${currentLocale}/wachstumsstrategien`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('StartUpsGrowthStrategyPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {GrowthStrategyAdvantage.map(item => (
              <Box
                Icon={Check}
