...
import {adviceOnTaxMattersAdvantages} from "@/assets/data/messages/adviceOnTaxMatters";
...
export async function generateMetadata({params}: { params: { locale: string; } }) {
  ...
  const t = await getTranslations("AdviceOnTaxMattersPage");

  return generatePageMetadata(`/${currentLocale}/beratung-in-steuerlichen-belangen`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('AdviceOnTaxMattersPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {adviceOnTaxMattersAdvantages.map(item => (
              <Box
                Icon={Check}
