...
import {businessAdviceAdvantages} from "@/assets/data/messages/businessAdvice";
...
export async function generateMetadata({params}: { params: { locale: string; } }) {
  ...
  const t = await getTranslations("BusinessAdvicePage");

  return generatePageMetadata(`/${currentLocale}/betriebswirtschaftliche-beratung`, t("HeroArticle.subtitle"), t("HeroArticle.description"));
}


export default function Page() {

  const t = useTranslations('BusinessAdvicePage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {businessAdviceAdvantages.map(item => (
              <Box
                Icon={Check}
