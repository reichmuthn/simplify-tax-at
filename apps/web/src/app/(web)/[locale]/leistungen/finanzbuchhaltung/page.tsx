...
import {financialAccountingAdvantages, financialAccountingFaqs} from "@/assets/data/messages/financialAccounting";
...
export async function generateMetadata({params}: { params: { locale: string; } }) {
  ...
  const t = await getTranslations("FinancialAccountingPage");

  return generatePageMetadata(`/${currentLocale}/finanzbuchhaltung`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('FinancialAccountingPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {financialAccountingAdvantages.map(item => (
              <Box
                Icon={Check}
      ...
      <Article>
        ...
        >
          <Faq faqs={financialAccountingFaqs.map(item => (
            {
