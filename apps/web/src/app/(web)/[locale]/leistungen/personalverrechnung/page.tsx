...
import {payrollAccountingAdvantages, payrollAccountingFaqs} from "@/assets/data/messages/payrollAccounting";
...
export async function generateMetadata({params}: { params: { locale: string; } }) {
  ...
  const t = await getTranslations("PayrollAccountingPage");

  return generatePageMetadata(`/${currentLocale}/personalverrechnung`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('PayrollAccountingPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {payrollAccountingAdvantages.map(item => (
              <Box
                Icon={Check}
      ...
      <Article>
        ...
        >
          <Faq faqs={payrollAccountingFaqs.map(item => (
            {
