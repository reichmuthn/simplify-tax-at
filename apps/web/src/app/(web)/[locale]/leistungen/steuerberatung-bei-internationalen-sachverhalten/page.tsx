...
import {taxAdviceOnInternationalMattersAdvantages} from "@/assets/data/messages/taxAdviceOnInternationalMatters";
...
export async function generateMetadata({params}: {params: {locale: string;}}) {
  ...
  const t = await getTranslations("CoTaxAdviceOnInternationalMattersPagentact");

  return generatePageMetadata(`/${currentLocale}/steuerberatung-bei-internationalen-sachverhalten`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('TaxAdviceOnInternationalMattersPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Grid maxCols={2}>
            {taxAdviceOnInternationalMattersAdvantages.map(item => (
              <Box
                Icon={Check}
