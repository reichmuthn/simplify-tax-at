...
import {taxReturnsAdvantages, taxReturnsFaqs} from "@/assets/data/messages/taxReturns";
...
export async function generateMetadata({params}: { params: { locale: string; } }) {
  ...
  const t = await getTranslations("TaxReturnsPage");

  return generatePageMetadata(`/${currentLocale}/steuererklaerung`, t("HeroArticle.title"), t("HeroArticle.description"));
}

export default function Page() {

  const t = useTranslations('TaxReturnsPage');
  ...
  return (
    <div>
      ...
      <Article>
        ...
        >
          <Faq faqs={taxReturnsFaqs.map(item => (
            {
