export const bookingMultiStepFormSubmittedClientNotification = `<!doctype html>
<html lang="de">
<head>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>[CLIENT] Booking Form Submitted</title>
                    ...
                    <tr>
                        <td class="wrapper"
                            ...
                            <p style="font-family: Helvetica, sans-serif; color: #08150E; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                Sehr geehrte/r {{params.firstName}} {{params.lastName}},</p>
                            <p style="font-family: Helvetica, sans-serif; color: #08150E; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 32px;">
                                vielen Dank für Ihre Terminbuchungsanfrage bei Simplify Tax.
                            </p>
                            <p style="font-family: Helvetica, sans-serif; color: #08150E; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                Hier sind die Buchungsinformationen Ihrer Anfrage:
                            </p>
                            <p style="font-family: Helvetica, sans-serif; color: #08150E; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                            ...
                            <p style="font-family: Helvetica, sans-serif; color: #08150E; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                Bitte beachten Sie, dass Ihr Termin erst verbindlich ist, wenn er von uns bestätigt wurde. Wir werden uns so schnell wie möglich mit Ihnen in Verbindung setzen, um den Termin zu bestätigen.</p>
                            <p style="font-family: Helvetica, sans-serif; color: #08150E; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                Mit freundlichen Grüßen,</p>
                            <p style="font-family: Helvetica, sans-serif; color: #08150E; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                Ihr Simplify Tax Team</p>
                        </td>
                    </tr>
