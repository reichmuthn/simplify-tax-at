...
import {DeleteBookingSlotsDialog} from "@ui/entities/bookingSlots/tables/admin/deleteDialog";

interface AdminBookingSlotItemsFloatingBarProps {
  table: Table<AdminBookingSlotItem>;
}

export function AdminBookingSlotItemsFloatingBar({
                                            table,
                                          }: AdminBookingSlotItemsFloatingBarProps) {
          ...
          <div className="flex items-center gap-1.5">
            <Tooltip>
              ...
              <TooltipContent className=" border bg-accent font-semibold text-foreground dark:bg-zinc-900">
                <p>BookingSlots exportieren</p>
              </TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <div>
                  <DeleteBookingSlotsDialog
                    bookingSlots={rows}
