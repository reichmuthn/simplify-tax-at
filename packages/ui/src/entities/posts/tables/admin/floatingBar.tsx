...
import { DeletePostsDialog } from "@ui/entities/posts/tables/admin/deleteDialog";

interface AdminPostItemsFloatingBarProps {
  table: Table<AdminPostItem>;
}

export function AdminPostItemsFloatingBar({
  table,
}: AdminPostItemsFloatingBarProps) {
