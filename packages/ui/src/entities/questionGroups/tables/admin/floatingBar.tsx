...
import { DeleteQuestionGroupsDialog } from "@ui/entities/questionGroups/tables/admin/deleteDialog";

interface AdminQuestionGroupItemsFloatingBarProps {
  table: Table<AdminQuestionGroupItem>;
}

export function AdminQuestionGroupItemsFloatingBar({
  table,
}: AdminQuestionGroupItemsFloatingBarProps) {
          ...
          <div className="flex items-center gap-1.5">
            <Tooltip>
              ...
              <TooltipContent className=" border bg-accent font-semibold text-foreground dark:bg-zinc-900">
                <p>QuestionGroups exportieren</p>
              </TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <div>
                  <DeleteQuestionGroupsDialog
                    questionGroups={rows}
