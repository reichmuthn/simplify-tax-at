...
import { DeleteTagGroupsDialog } from "@ui/entities/tagGroups/tables/admin/deleteDialog";

interface AdminTagGroupItemsFloatingBarProps {
  table: Table<AdminTagGroupItem>;
}

export function AdminTagGroupItemsFloatingBar({
  table,
}: AdminTagGroupItemsFloatingBarProps) {
          ...
          <div className="flex items-center gap-1.5">
            <Tooltip>
              ...
              <TooltipContent className=" border bg-accent font-semibold text-foreground dark:bg-zinc-900">
                <p>TagGroups exportieren</p>
              </TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <div>
                  <DeleteTagGroupsDialog
                    tagGroups={rows}
