...
import { DeleteTermsDialog } from "@ui/entities/terms/tables/admin/deleteDialog";

interface AdminTermItemsFloatingBarProps {
  table: Table<AdminTermItem>;
}

export function AdminTermItemsFloatingBar({
  table,
}: AdminTermItemsFloatingBarProps) {
